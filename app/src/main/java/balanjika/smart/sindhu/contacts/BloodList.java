...
public class BloodList extends ActionBarActivity implements
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        BloodList.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1")
                .setIndicator("Blood List"), (tabInfo = new TabInfo(
                "Tab1", BloodList_Fragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
        BloodList.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2")
                .setIndicator("Doctors"), (tabInfo = new TabInfo(
                "Tab2", BloodList_Fragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
